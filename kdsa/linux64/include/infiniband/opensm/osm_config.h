...
#define HAVE_DEFAULT_NODENAME_MAP "/etc/rdma/ib-node-name-map"

/* Define a default OpenSM config file */
#define HAVE_DEFAULT_OPENSM_CONFIG_FILE "/etc/rdma/opensm.conf"

/* Define a Partition config file */
#define HAVE_DEFAULT_PARTITION_CONFIG_FILE "/etc/rdma/partitions.conf"

/* Define a Prefix Routes config file */
#define HAVE_DEFAULT_PREFIX_ROUTES_FILE "/etc/rdma/prefix-routes.conf"

/* Define a QOS policy config file */
#define HAVE_DEFAULT_QOS_POLICY_FILE "/etc/rdma/qos-policy.conf"

/* Define OpenSM config directory */
#define OPENSM_CONFIG_DIR "/etc/rdma"
